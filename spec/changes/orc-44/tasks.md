...
- [ ] T-1: Write regression test that fails with `tools:` key and passes with `tool_calls:`
...
- [ ] T-2: Rename `tools:` → `tool_calls:` in CONVENTIONS.md and state-with-tools.yaml fixture
...
- [ ] T-3: Confirm regression test passes and full suite is green
