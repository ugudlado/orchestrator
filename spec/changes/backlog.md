...
| 4 | [fix-inline-scripts-tmpdir](#fix-inline-scripts-tmpdir) | Fix inline scripts mktemp TMPDIR (ISSUE-20) | 5.3 |
...
## fix-inline-scripts-tmpdir

**Fix inline scripts mktemp TMPDIR (ISSUE-20)** (score 5.3)
