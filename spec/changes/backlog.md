...
## blog-post-pi-coding-agent-on-rented-gpu

**Blog post: running the Pi coding agent against a rented GPU (qwen3.6 27B over Tailscale)** (score 6.0)
...
## document-or-script-state-seeding

**Document or script the initial state.yaml seed for /orchestrate** (score 9.0)
