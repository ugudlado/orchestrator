...
- [ ] T-3: Create agents/workflow-learner.md from skills/learn/SKILL.md
...
- [ ] T-4: Convert skills/learn/SKILL.md to a thin agent-spawning wrapper
...
- [ ] T-5: Convert run-learn-cycle.yaml to agent: workflow-learner
...
- [ ] T-6: Run full test suite — zero new failures
