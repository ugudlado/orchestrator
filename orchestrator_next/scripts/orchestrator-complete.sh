...
#
# Usage (workflow: config/workflows/complete.yaml):
...
PY
  ...
  COMMIT_HELPER="$_COMPLETE_DIR/commit-worktree-learn-updates.sh"
...
set +e
_MERGE_OUT=$(REPO_ROOT="$REPO_ROOT" BRANCH="$BRANCH" CHANGE_ID="$CHANGE_ID" \
