...
5. Write discovery brief to $WORKTREE_ARTIFACT_DIR/$CHANGE_ID/discovery.md, using the
   template at $ORCHESTRATOR_CONFIG/steps/explore/pack/templates/$SCHEMA/discovery.md as
   ...
   **Producing discovery.md? First Read `$ORCHESTRATOR_CONFIG/steps/explore/pack/reference/discovery-format.md`**
