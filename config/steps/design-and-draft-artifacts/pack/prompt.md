...
4. Record the chosen direction and rationale in discovery.md's "Key Decisions" section
   per the Discovery Brief Format Contract in config/steps/explore/pack/prompt.md.
...
6. For each file needing generation:
   a. Read the template:
   - design.md → $ORCHESTRATOR_CONFIG/steps/design-and-draft-artifacts/pack/templates/$SCHEMA/design.md
   - tasks.yaml → $ORCHESTRATOR_CONFIG/steps/design-and-draft-artifacts/pack/templates/$SCHEMA/tasks.yaml
     ...
     - Producing design.md? First Read
       `$ORCHESTRATOR_CONFIG/steps/design-and-draft-artifacts/pack/reference/design-format.md`.
     - Producing tasks.yaml? First Read
       `$ORCHESTRATOR_CONFIG/steps/design-and-draft-artifacts/pack/reference/tasks-format.md`.
...
- Output MUST follow the Tasks YAML Format Contract in `$ORCHESTRATOR_CONFIG/steps/design-and-draft-artifacts/pack/reference/tasks-format.md`.
