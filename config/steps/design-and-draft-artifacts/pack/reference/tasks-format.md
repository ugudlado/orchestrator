...
The authoritative template is `$ORCHESTRATOR_CONFIG/steps/design-and-draft-artifacts/pack/templates/$SCHEMA/tasks.yaml`
...
`config/steps/design-and-draft-artifacts/pack/validate-tasks-yaml.sh <path-to-tasks.yaml>` — exits 0
