...
- Do not emit `agent:` in tasks.yaml — it is an internal dispatch field, not part of the task contract. The default is developer; set it only via state.yaml flags, not per-task. <!-- learned: 2026-05-26, source: orc-86, cycle: 1, hits: 14, misses: 1, repo: orchestrator -->
