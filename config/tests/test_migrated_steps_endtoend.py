...
# ORC-106: orchestrator_next package at repo root.
# orchestrator_next/tests/ -> orchestrator_next/ -> <repo_root>
_REPO_ROOT = os.path.abspath(os.path.join(_HERE, "..", ".."))
_SCRIPTS_DIR = _REPO_ROOT  # package import path (repo root)
