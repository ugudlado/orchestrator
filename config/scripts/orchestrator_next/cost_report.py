...
def aggregate_feature(db, repo_root: str, change_id: str) -> dict:
    ...
    All rollups come from DuckDB — driver-loop turns are ingested as synthetic
    step_events rows (agent_name='driver-loop') so per-agent / per-phase
    GROUP BY naturally includes them.
