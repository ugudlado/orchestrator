...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `classification_correctness` | Classifies each step correctly as shell (deterministic), skill (probabilistic/LLM judgment), or prompt, and never puts probabilistic work in shell or deterministic work in skill/prompt. | Misclassifies a step's nature, or picks a step type based on convenience rather than what the step actually requires. |
