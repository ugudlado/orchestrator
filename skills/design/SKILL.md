...
4. Record the chosen direction and rationale in discovery.md's "Key Decisions" section
   per the Discovery Brief Format Contract in skills/explore/SKILL.md.
...
6. For each file needing generation:
   a. Read the template:
   - design.md → skills/design/templates/$SCHEMA/design.md
   - tasks.yaml → skills/design/templates/$SCHEMA/tasks.yaml
     ...
     - Producing design.md? First Read
       `skills/design/reference/design-format.md`.
...
- Output MUST follow the Tasks YAML Format Contract in `skills/design/reference/tasks-format.md`.
