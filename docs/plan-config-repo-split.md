...
| Step→model binding                               | ⚠️ pack-owned                    | `contract.yaml` hardcodes `model: opus\|sonnet\|composer` per step. The _user's machine_ can remap what an alias routes to, but cannot re-tier a step (e.g. run `implement-tasks` on sonnet) without editing the pack.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
