...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `gate_discipline`       | Deterministic gate runs first; needs_work returns status failed with refresh_artifacts; only `## Review` in design.md is edited (feedback template); caps applied (crit→4, imp→7). | Scoring past a failed gate, needs_work as completed, editing design body/tasks.yaml, writing design-review.md / emitting design_review_result, wrong caps. |
